    ...
    const faqs = [
        {
            ...
            answer: "You can register your product for warranty by visiting our warranty registration portal and providing your product details, purchase information, and contact details. Alternatively, you can contact our customer support team who will assist you with the registration process.",
            category: 'warranty'
        },
        {
            id: 2,
            question: "What is the typical response time for service requests?",
            answer: "For critical issues, our team responds within 2 hours. For high priority issues, we respond within 4 hours. Standard service requests are addressed within 24 hours during business days.",
            category: 'services'
        },
        {
            id: 3,
            question: "How often should I schedule maintenance for my equipment?",
            answer: "Maintenance frequency depends on your equipment type and usage. Generally, we recommend scheduled maintenance every 250 operating hours or every 6 months, whichever comes first. Consult your equipment manual for specific recommendations.",
            category: 'technical'
        },
        {
            id: 4,
            question: "Where can I find product manuals and documentation?",
            answer: "All product manuals and documentation are available in our resource center. You can search by product model number or category to find the specific documents you need. If you can't find what you're looking for, contact our support team.",
            category: 'products'
        },
        {
            id: 5,
            question: "What is covered under the standard warranty?",
            answer: "Our standard warranty covers defects in materials and workmanship for a period of 12 months from the date of purchase. It includes parts and labor for repairs needed due to manufacturing defects. Normal wear and tear, misuse, and unauthorized modifications are not covered.",
            category: 'warranty'
        },
        {
            id: 6,
            question: "How can I order spare parts for my equipment?",
            answer: "You can order spare parts through our online parts portal, by contacting your regional service center, or by calling our parts hotline. Have your equipment model number and serial number ready for faster service.",
            category: 'products'
        }
    ];
